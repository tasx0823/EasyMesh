...
import numpy as np
import shutil
from model_folding import GeoGan
import tensorflow as tf

parser = argparse.ArgumentParser(description='')
parser.add_argument('--dataset_name', dest='dataset_name', default='airplane', help='name of the dataset')
parser.add_argument('--epoch', dest='epoch', type=int, default=700, help='# of epoch')
...
parser.add_argument('--checkpoint_dir', dest='checkpoint_dir', default='experiments/ckpt/',
                    help='models are saved here')
parser.add_argument('--sample_dir', dest='sample_dir', default='experiments/sample/', help='sample are saved here')
...
def main(_):
	...
	with tf.Session(config=config) as sess:
		model = GeoGan(sess, image_size=64, batch_size=args.batch_size,
